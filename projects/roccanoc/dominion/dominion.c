...
int playAdventurer()
{
  ...
  //bug: does not recognize copper cards as treasure, only increasing count on silver and gold**************************
...
int playSmithy()
{
  //bug: i <= 3 causes 4 cards to be drawn***********************************************************
  //+3 Cards
      for (i = 0; i <= 3; i++)
  {
    drawCard(currentPlayer, state);
...
int playMine()
{
  ...
  //bug: chosen card goes into discard rather than hand***************************************************
...
int playOutpost()
{
    // bug: deletion of state->outpostPlayed++; allows multiple outpost plays without flag being set *********************************

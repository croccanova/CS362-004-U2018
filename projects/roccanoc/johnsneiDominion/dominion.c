// Dominion code of teammate Neil Johnson ONID: johnsnei
...
/**********************************************
* THIS IS THE SECTION WE MUST MODIFY FOR HW 2
*
* TODO: REMOVE SWITCH STATEMENT AND CHANGE IT
* SO THAT EACH CARD HAS IT'S OWN FUNCTION
*********************************************/

/**********************************************
* MANDATORY CARDS TO DO
**********************************************/

/**********************************************
* ADVENTURER CARD:
* Description:Reveal the top 4 cards of your
* deck. Put the revealed Coppers and Potions
* into your hand. Put the other cards back on
* top in any order.
* Parameters:
* 	- State (Reference to)
* 	- currentPlayer
...
* 	- z (value)
*********************************************/
void adventurerCard(struct gameState *state, int currentPlayer, int temphand[], int z) {
	// Variables needed in this call again:
	...
	// return 0; <- This should no longer be necessary as we are doing a void function now rather than a switch
}
...
void greatHallCard(struct gameState *state, int currentPlayer, int handPos) {
	//+1 Card
	drawCard(currentPlayer, state);
	drawCard(currentPlayer, state);  // ** ERROR: Drawing 2 cards rather than 1 **
...
/**********************************************
* COUNCIL ROOM CARD:
* Description: +4 Cards, +1 Buys, Rest of
* Players also draw cards
* Parameters:
* 	- State
* 	- currentPlayer
* 	- handPos
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
	...
	switch (card)
	{
		...
		*****************************/
	case adventurer:
		adventurerCard(state, currentPlayer, temphand, z);
		return 0;
